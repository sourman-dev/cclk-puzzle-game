...
const accentBgClass = computed((): string => {
...
const disabledClass = computed((): string => {
  ...
  return colorMap[accentColor.value] as string ?? DEFAULT_DISABLED
})
