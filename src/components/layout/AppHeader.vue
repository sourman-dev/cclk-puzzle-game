...
<template>
  <header
    class="flex items-center justify-between px-4 py-3 pt-safe bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
    <button @click="emit('goHome')" class="flex items-center gap-2">
      ...
      <div class="flex flex-col items-start">
        ...
        <span class="text-[10px] text-gray-400 leading-tight">v0.1.12</span>
      </div>
    </button>
    ...
    <div class="flex items-center gap-2">
      ...
      <button @click="emit('openSettings')" class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
        title="Cài đặt">
        ⚙️
      </button>
    </div>
